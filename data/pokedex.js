...
let BattlePokedex = {
	squip: {
		...
		baseStats: {hp: 50, atk: 54, def: 50, spa: 70, spd: 56, spe: 40},
	...
	longsquip: {
		...
		baseStats: {hp: 70, atk: 64, def: 63, spa: 80, spd: 80, spe: 60},
	...
	omegasquiddi: {
		num: 3,
		species: "Omega Squiddi",
		types: ["Water", "Psychic"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 90, atk: 70, def: 70, spa: 115, spd: 90, spe: 90},
		abilities: {0: "Trace"},
		heightm: 2,
		weightkg: 12,
		color: "Blue",
	...
	krabbi: {
		...
		types: ["ground"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 56, atk: 66, def: 60, spa: 48, spd: 45, spe: 38},
